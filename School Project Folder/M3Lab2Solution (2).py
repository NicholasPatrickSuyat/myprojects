...
while (name != "quit"):
    ...
    interest = float(input("What is the interest rate (expressed as a decimal number)? "))
    ...
    print("Your loan is for", months, "months at", interest, "interest")
    ...
    print("The interest rate for one month is", interest_rate)
    print("The compound interest rate is", compound_interest)
    ...
    print ("Your monthly payment will be ${0:.2f}" .format(payments))
